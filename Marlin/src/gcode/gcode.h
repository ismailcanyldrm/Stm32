...
private:
  ...
  static void M1461(); // A-B TEMİZLİK
  static void M1463(); // A TEMİZLİK
  static void M1465(); // B TEMİZLİK
  static void M5000(); // KARIŞTIRMA START
  //static void M8181(); // PRINTER START
  //static void M8080(); // PRINTER STOP
