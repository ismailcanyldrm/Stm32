...
//
  ...
  //#define HEATER_CHAMBER_PIN      PA2   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
...
#define CASE_LIGHT_ENABLE
  ...
  //#define CASE_LIGHT_MENU                   // Add Case Light options to the LCD menu
    ...
    #define CASE_LIGHT_DEFAULT_COLOR { 0, 255, 0 } // { Red, Green, Blue}
...
//#define E_DUAL_STEPPER_DRIVERS
  ...
  //#define INVERT_E1_VS_
  _DIR   // Enable if the E motors need opposite DIR states
#endif
...
#define HOMING_BUMP_MM      { 5, 5, 2 }       // (mm) Backoff from endstops after first bump {5, 5, 5}
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 1.4    // Unit: mm compression per 1mm/s extruder speed //eski: 0.22 (bugra)
 ...
 */
  ...
  #define PROBE_PT_2_X 299
  #define PROBE_PT_2_Y 50
  #define PROBE_PT_3_X 170
  #define PROBE_PT_3_Y 275
#endif
 ...
 */
#define EMERGENCY_PARSER  //m108 ile manual continue vermek için açtık.
 ...
 */
 ...
 #define HYBRID_THRESHOLD
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  128 // daha önce 8
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  128 // daha önce 8
...
//#define CUSTOM_USER_BUTTONS
  ...
  #define BUTTON1_PIN PC5
    ...
    #define BUTTON1_GCODE         "M2828"
    #define BUTTON1_DESC          "DUR"  // Optional string to set the LCD status
  #endif

  #define BUTTON2_PIN PD13
  #if PIN_EXISTS(BUTTON2)
    #define BUTTON2_HIT_STATE     LOW
    #define BUTTON2_WHEN_PRINTING false
    #define BUTTON2_GCODE         "M2828" //STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
    #define BUTTON2_DESC          "DUR1" //PREHEAT_1_LABEL
  #endif
  ...
  #define BUTTON3_PIN PA5
    ...
    #define BUTTON3_GCODE         "M2828" //STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)
    #define BUTTON3_DESC          "DUR2" //PREHEAT_2_LABEL
  #endif
#endif
