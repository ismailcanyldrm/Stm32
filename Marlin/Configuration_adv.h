...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 1.05 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 1.05        // (mm) Compression length applying to all extruders
  #endif
